...
function SuperAdminDashboard() {
  ...
  }, [viewMode, loadRequests, loadAllRequestsForHistory, checkForNewNotifications, loadDepartments, calculateUserStats]);
  ...
  const loadAllRequestsForHistory = useCallback(async () => {
  ...
  }, [loadRequests, user.id, selectedRequest]);
