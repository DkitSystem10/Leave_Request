...
function HRDashboard() {
  ...
  const handleRequestSubmitted = () => {
    loadRequests();
    setActiveTab('approved'); // Redirect to 'Approved' tab after submission to see status
  };
      ...
      <div style={{ width: '280px', background: 'white', borderRight: '1px solid #e2e8f0', display: 'flex', flexDirection: 'column', position: 'fixed', left: 0, top: 0, bottom: 0, zIndex: 50, boxShadow: '4px 0 24px rgba(0,0,0,0.02)' }}>
        ...
        <div style={{ padding: '32px 24px', borderBottom: '1px solid #f1f5f9' }}>
          <h2 style={{ margin: 0, fontSize: '24px', fontWeight: '800', display: 'flex', alignItems: 'center', gap: '12px', letterSpacing: '-0.5px' }}>
            ...
            <span style={{ background: 'linear-gradient(90deg, #1e293b, #334155)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>HR Portal</span>
          </h2>
        </div>

        {/* NAVIGATION */}
        <div style={{ padding: '24px 16px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
          <SidebarItem active={view === 'welcome'} label="Home" onClick={() => setView('welcome')} color="blue" icon={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" /></svg>} />

          <SidebarItem active={view === 'leave'} label="Leave Management" onClick={() => { setView('leave'); setActiveTab('pending'); }} color="indigo" icon={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M3 3h7v7H3V3zm11 0h7v7h-7V3zM3 14h7v7H3v-7zm11 0h7v7h-7v-7z" /></svg>} />

          <SidebarItem active={view === 'users'} label="User Management" onClick={() => { setView('users'); setActiveTab('users'); setSettingsView(null); }} color="fuchsia" icon={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z" /></svg>} />

          <SidebarItem active={view === 'holiday'} label="Holiday Settings" onClick={() => { setView('holiday'); setActiveTab('holidays'); }} color="cyan" icon={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" /></svg>} />

          <SidebarItem active={view === 'directory'} label="Employee Directory" onClick={() => { setView('directory'); setActiveTab('departments'); }} color="purple" icon={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z" /></svg>} />

          <SidebarItem active={view === 'reports'} label="Reports" onClick={() => { setView('reports'); setActiveTab('reports'); }} color="indigo" icon={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M2 10a1 1 0 011-1h4a1 1 0 011 1v10a1 1 0 01-1 1H3a1 1 0 01-1-1V10zM8 4a1 1 0 011-1h4a1 1 0 011 1v16a1 1 0 01-1 1H9a1 1 0 01-1-1V4zM14 7a1 1 0 011-1h4a1 1 0 011 1v13a1 1 0 01-1 1h-4a1 1 0 01-1-1V7z" /></svg>} />
        </div>
        ...
        {view === 'welcome' ? (
          <div style={{ flex: 1, background: '#f8fafc', padding: '40px', overflowY: 'auto' }}>
            <div style={{ maxWidth: '1600px', margin: '0 auto' }}>
              ...
              <div style={{ background: 'white', borderRadius: '20px', padding: '32px', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.05), 0 2px 4px -1px rgba(0, 0, 0, 0.03)', marginBottom: '40px' }}>
          ...
          <div className="dashboard-content" style={{ padding: '40px', maxWidth: '1600px', margin: '0 auto', width: '100%' }}>
            ...
            {view === 'leave' && (
              <div className="stats-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '24px', marginBottom: '32px' }}>
                ...
                <div
                  ...
                  style={{
                    cursor: 'pointer',
                    background: activeTab === 'pending' ? 'linear-gradient(135deg, #3b82f6 0%, #2563eb 100%)' : 'white',
                    color: activeTab === 'pending' ? 'white' : '#1e293b',
                    boxShadow: activeTab === 'pending' ? '0 12px 24px rgba(37, 99, 235, 0.3)' : '0 4px 6px rgba(0, 0, 0, 0.05)',
                    border: activeTab === 'pending' ? 'none' : '1px solid #e2e8f0',
                    transition: 'all 0.3s',
                    transform: activeTab === 'pending' ? 'translateY(-4px)' : 'translateY(0)',
                    borderRadius: '20px',
                    padding: '24px',
                    display: 'flex',
                    flexDirection: 'column',
                ...
                >
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                    <div style={{ width: '48px', height: '48px', borderRadius: '12px', background: activeTab === 'pending' ? 'rgba(255,255,255,0.2)' : '#fffbeb', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={activeTab === 'pending' ? 'white' : '#d97706'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
                    </div>
                    <div style={{ fontSize: '32px', fontWeight: '800' }}>{stats.pending}</div>
                  </div>
                  <div style={{ fontSize: '15px', fontWeight: '600', opacity: activeTab === 'pending' ? 0.9 : 0.7 }}>Pending Approval</div>
                </div>
                ...
                >
                  ...
                  <div style={{ fontSize: '15px', fontWeight: '600', opacity: activeTab === 'apply' ? 0.9 : 0.7 }}>Leave / Permission Requests</div>
                </div>
                ...
                >
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                    <div style={{ width: '48px', height: '48px', borderRadius: '12px', background: activeTab === 'approved' ? 'rgba(255,255,255,0.2)' : '#ecfdf5', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={activeTab === 'approved' ? 'white' : '#059669'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
                    </div>
                    <div style={{ fontSize: '32px', fontWeight: '800' }}>{stats.approvedOwn}</div>
                  </div>
                  <div style={{ fontSize: '15px', fontWeight: '600', opacity: activeTab === 'approved' ? 0.9 : 0.7 }}>Recent Leave Approved</div>
                </div>
              </div>
            )}
            ...
            <div className="card" style={{ background: 'transparent', boxShadow: 'none', border: 'none', padding: 0 }}>
                  ...
                  <div className="departments-accordion-container" style={{ maxWidth: '1000px', margin: '0 auto', fontFamily: 'Inter, sans-serif' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                      {departmentsList.filter(dept => {
                        ...
                        const emps = (dataService.getAllEmployees() || []).filter(e => e.department === dept.name);
                        return emps.some(e => e.name.toLowerCase().includes(term));
                      }).map(dept => {
                        const deptEmployees = (dataService.getAllEmployees() || [])
              ...
              {
                activeTab === 'reports' && settingsView === null && (
...

              {
                activeTab === 'users' && (
                  <div className="settings-section settings-swipe-down" style={{ padding: '24px', paddingBottom: '100px' }}>
                    ...
                    {!settingsView && (
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', marginTop: '40px', maxWidth: '800px' }}>
                        <div onClick={() => setSettingsView('addUser')} className="interactive-card" style={{ display: 'flex', alignItems: 'center', gap: '24px', padding: '32px', cursor: 'pointer', background: 'white', borderRadius: '16px', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)', transition: 'all 0.3s ease' }}>
                          ...
                          <div>
                            <h3 style={{ margin: '0 0 8px 0', fontSize: '20px', color: '#1e293b', fontWeight: 'bold' }}>Add New User</h3>
                            <p style={{ margin: 0, color: '#64748b', fontSize: '15px' }}>Create employee accounts and assign roles</p>
                          </div>
                          <div style={{ marginLeft: 'auto', color: '#cbd5e1', fontSize: '24px' }}>→</div>
                        </div>

                        <div onClick={() => setSettingsView('editUser')} className="interactive-card" style={{ display: 'flex', alignItems: 'center', gap: '24px', padding: '32px', cursor: 'pointer', background: 'white', borderRadius: '16px', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)', transition: 'all 0.3s ease' }}>
                          ...
                          <div>
                            <h3 style={{ margin: '0 0 8px 0', fontSize: '20px', color: '#1e293b', fontWeight: 'bold' }}>Edit User Details</h3>
                            <p style={{ margin: 0, color: '#64748b', fontSize: '15px' }}>Update employee information and roles</p>
                          </div>
                          <div style={{ marginLeft: 'auto', color: '#cbd5e1', fontSize: '24px' }}>→</div>
                        </div>

                        <div onClick={() => setSettingsView('deactivate')} className="interactive-card" style={{ display: 'flex', alignItems: 'center', gap: '24px', padding: '32px', cursor: 'pointer', background: 'white', borderRadius: '16px', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)', transition: 'all 0.3s ease' }}>
                          ...
                          <div>
                            <h3 style={{ margin: '0 0 8px 0', fontSize: '20px', color: '#1e293b', fontWeight: 'bold' }}>Deactivate User</h3>
                            <p style={{ margin: 0, color: '#64748b', fontSize: '15px' }}>Disable access for former employees</p>
                          </div>
                          <div style={{ marginLeft: 'auto', color: '#cbd5e1', fontSize: '24px' }}>→</div>
                        </div>
                      </div>
...

              {
                activeTab === 'approved' && (
                  <div className="requests-section">
                    <div className="card-header">
                      <h3>Recent Leave Approved ({myRequests.filter(r => r.status === 'approved').length})</h3>
